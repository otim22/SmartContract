...
Here is how this contract is used:
    1. Alice deploys the contract, funding it with some Ether.
    2. Alice authorizes a payment by signing a message (off chain) and sends the signature to Bob.
    3. Bob claims his payment by presenting the signed message to the smart contract.
    4. If Bob does not claim his payment, Alice get her Ether back after the contract expires
